...
def test_sglang_spmd():
    ...
    # assert are_lists_similar(hf_response_tokens, sglang_response_tokens), f"Strings differ more than 10%:\n"
    # print("Check Pass")
...
# torchrun --standalone --nnodes=1 --nproc_per_node=8 $(which pytest) -s playground/sglang_rollout/test_sglang_spmd.py
