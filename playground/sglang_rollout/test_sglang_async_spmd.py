...
from utils_sglang import (are_lists_similar, clean_torchelastic_env,
                          generate_hf_output, initialize_global_process_group,
                          load_tokenizer_and_model, prepare_inputs)
...
def test_sglang_spmd():
    ...
    local_model_path = "/nobackup/model/deepseek-r1/DeepSeek-R1-Distill-Llama-8B"
    ...
    if tp_rank == 0:
        ...
        # print(f"llm={llm.get_server_info()}")
        # exit()
...
# torchrun --standalone --nnodes=1 --nproc_per_node=2 $(which pytest) -s playground/sglang_rollout/test_sglang_async_spmd.py