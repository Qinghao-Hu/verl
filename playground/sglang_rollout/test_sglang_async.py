"""
torchrun --standalone --nnodes=1 --nproc_per_node=2 $(which pytest) -s playground/sglang_rollout/test_sglang_async.py
"""
...
from utils_sglang import (are_lists_similar, clean_torchelastic_env,
                          generate_hf_output, get_rollout_config,
...
def test_async_sglang_rollout_w_tool():
    ...
    local_model_path = "/nobackup/model/qwen2.5/Qwen2.5-0.5B-Instruct"
