# python -u playground/test_chat_scheduler_sync.py
...
def init_config() -> DictConfig:
    config = OmegaConf.load("/homes/qinghaoh/workdir/verl-dev/playground/grpo_config.yaml")
    assert isinstance(config, DictConfig), "Expected DictConfig from OmegaConf.load"
    model_path = "/dataset/model/qwen2.5/Qwen2.5-1.5B-Instruct"#-Instruct
    ...
    config.actor_rollout_ref.rollout.early_memory_release = True  # Enable early memory release
    # config.trainer.rollout_data_dir = "/homes/qinghaoh/workdir/verl-dev/playground/rollout_data"
...
ray.init(runtime_env={"env_vars": {"TOKENIZERS_PARALLELISM": "true", "NCCL_DEBUG": "WARN", "RAY_DEBUG_POST_MORTEM": "1"}}, num_cpus=96)
# data_path = "/homes/qinghaoh/workdir/verl-dev/playground/gen_batch_example.pkl"
data_path = "/homes/qinghaoh/workdir/verl-dev/playground/gen_batch_example_infinite.pkl"
output_path = "/homes/qinghaoh/workdir/verl-dev/playground/rollout_data"
